...
//				showCurrentAtPos: 1 // bug; use maxDate instead
	...
	function buildButtonPanel(classnameContext, options, handlers) {
		...
		function init() {
			$self = $('<div class="btn-footer"></div>')
				.addClass(classnameContext + '-buttonpanel');

			if (options.applyButtonText) {
				applyButton = $('<button type="button" class="ui-priority-primary btn  btn-blue"></button>')
			...
			if (options.clearButtonText) {
				clearButton = $('<button type="button" class="ui-priority-secondary btn btn-lightblue"></button>')
			...
			if (options.cancelButtonText) {
				cancelButton = $('<button type="button" class="ui-priority-secondary btn btn-grey"></button>')
