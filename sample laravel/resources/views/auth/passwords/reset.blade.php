				...
				<div class="row">
					<div class="col-md-8 login-card-left">
						<div class="login-inner">
							...
							<form class="ajax-form" method="POST" action="{{ route('reset_password') }}" novalidate id="reset_form" >
								@csrf
								...
								<div class="form-group login-submtbtn ">
									<button type="submit" id="reset_submit" class="btn blue-btn btn-primary">
										<!--{{ __('Reset Password') }}-->
										Submit
									</button>
								</div>
