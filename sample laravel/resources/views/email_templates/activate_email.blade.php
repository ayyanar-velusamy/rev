                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding-bottom:40px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">Your {{ env('APP_NAME','') }} account has been Activated.</span>
                                    </td>
                                </tr>
								<tr>
                                    <td style="padding-bottom:30px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">Login to your {{ env('APP_NAME','') }} account to pursue your Learning Journey</span>
                                    </td>
                                </tr>
								
                                <tr>
                                    <td style="padding-bottom:40px;">
                                        <a href="{{ url('/') }}" style=" border-radius:50px; text-align:center; background:#bbdc00; font-size:15px; font-weight:bold; color:#5a5a5a; max-width:240px; line-height:50px; display:block; margin:0 auto;"> {{ __('Login') }}</a>
                                    </td>
                                </tr>
								<tr>
