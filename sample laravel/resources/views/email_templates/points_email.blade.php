                            ...
                            <tbody>
								...
								<tr>
                                    <td style="padding-bottom:40px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">Congratulations!,</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom:40px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">You have gained {{$milestone->point }} more points on your Learning Journeys</span>
                                    </td>
                                </tr>
								<tr>
                                    <td style="padding-bottom:40px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">Please click on the below link to view the Details</span>
                                    </td>
                                </tr>
										
								<tr>
                                    <td style="padding-bottom:25px;">
                                        <a href="{{ url('/passport')}}" style=" border-radius:50px; text-align:center; text-decoration:none; background:#bbdc00; font-size:15px; font-weight:bold; color:#5a5a5a; max-width:240px; line-height:50px; display:block; margin:0 auto;"> {{ __('View Passport') }}</a>
                                    </td>
                                </tr>
								<tr>
