                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding-bottom:40px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">You have been removed from the {{$group['group_name']}} Group by {{$group['removed_name']}}</span>
                                    </td>
                                </tr>								
								<tr>
