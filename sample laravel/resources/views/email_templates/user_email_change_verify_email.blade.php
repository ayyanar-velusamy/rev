                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding-bottom:30px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">Admin has updated your email address. Kindly click here to verify your new email address.</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom:25px;">
                                        <a href="{{ $link }}" style=" border-radius:50px; text-decoration:none; text-align:center; background:#bbdc00; font-size:15px; font-weight:bold; color:#5a5a5a; max-width:240px; line-height:50px; display:block; margin:0 auto;"> {{ __('Verification link') }}</a>
                                    </td>
                                </tr>
								<tr>
