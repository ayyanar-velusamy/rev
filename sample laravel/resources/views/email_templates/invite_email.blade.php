                 ...
                 <tr>
                    <td>
                        <div class="banner" style="position:relative;">
							...
							<h1 style="color:#fff; font-size:35px; position:absolute; left:0px;right:0px; text-align:center; top:20%;"><span style="display:block; color:#bbdc00; font-size:20px; line-height:20px;height: 20px;">Welcome To</span> Learning Experience Platform </h1>
						<div>
                    </td>
                </tr>
