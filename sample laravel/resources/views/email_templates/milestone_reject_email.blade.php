                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding-bottom:40px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">Your {{ $approval->milestone()->title }} milestone has been rejected by {{ $approval->updated_by()->first_name." ".$approval->updated_by()->last_name }}</span>
                                    </td>
                                </tr>
								<tr>
