                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding-bottom:40px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">{{$user_name}} has completed a Learning Journey. Please find below the Journey Details</span>
                                    </td>
                                </tr>
								<tr>
                                    <td style="padding-bottom:40px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">Journey Details:<p>Journey Name : {{$journey->journey_name}}</p>
										<p>Journey Assigned By : {{$journey->assigned_name}}</p>
										<p>Optional or Compulsory : {{ucfirst($journey->read)}}</p>
										<p>Milestone Count : {{$journey->milestone_count}}</p>
										<p>Ratings : {{journeyAvgRating($journey->journey_id)}}</p>
										</span>
                                    </td>
                                </tr>
								<tr>
                                    <td style="padding-bottom:40px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">Please click on the below link to view the Journey</span>
                                    </td>
                                </tr>
										
								<tr>
                                    <td style="padding-bottom:25px;">
                                        <a href="{{ route('journeys.assigned_journey_show',[encode_url($journey->journey_id)])}}" style=" border-radius:50px; text-align:center; text-decoration:none; background:#bbdc00; font-size:15px; font-weight:bold; color:#5a5a5a; max-width:240px; line-height:50px; display:block; margin:0 auto;"> {{ __('View Journey') }}</a>
                                    </td>
                                </tr>
								<tr>
