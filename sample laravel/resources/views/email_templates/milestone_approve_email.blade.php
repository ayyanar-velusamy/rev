                            ...
                            <tbody>
                                <tr>
                                    <td style="padding-bottom:25px;">
                                        <h3 style="font-size: 24px; color:#384f98;font-weight: 400; text-align:center; padding:0 0 10px; margin:0px;">Dear {{ $approval->creator()->first_name." ".$approval->creator()->last_name }},</h3>
                                        <span style="border-bottom:1px solid #384f98; max-width:50px; display:block; margin:0 auto;"></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom:40px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">Your {{ $approval->milestone()->title }} milestone has been approved by {{ $approval->updated_by()->first_name." ".$approval->updated_by()->last_name }}</span>
                                    </td>
                                </tr>
								<tr>
                                    <td style="padding-bottom:30px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">{{$approval->comment}}</span>
                                    </td>
                                </tr>
								<tr>
