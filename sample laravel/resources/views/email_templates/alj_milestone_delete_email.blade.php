                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding-bottom:40px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">{{$user_name}}  has deleted the following Milestone from {{$milestone->journey_name}} Journey. Please find below the Milestone Details</span>
                                    </td>
                                </tr>
								<tr>
                                    <td style="padding-bottom:40px; ">
