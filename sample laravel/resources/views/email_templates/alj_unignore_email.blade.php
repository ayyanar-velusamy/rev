                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding-bottom:40px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">{{$user_name}} has un-ignored the following Learning Journey. Please find below the Journey Details</span>
                                    </td>
                                </tr>
								<tr>
                                    <td style="padding-bottom:40px; ">
