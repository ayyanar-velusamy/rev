                            ...
                            <tbody>
                                <tr>
                                    <td style="padding-bottom:25px;">
                                        <h3 style="font-size: 24px; color:#384f98;font-weight: 400; text-align:center; padding:0 0 10px; margin:0px;">Dear {{ $group['user_name']}},</h3>
                                        <span style="border-bottom:1px solid #384f98; max-width:50px; display:block; margin:0 auto;"></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom:40px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">You have been made admin to the {{$group['group_name']}} Group by {{$group['added_name']}}</span>
                                    </td>
                                </tr>
								<tr>
                                    <td style="padding-bottom:30px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">Please click on the below link to view group</span>
                                    </td>
                                </tr>
								
                                <tr>
                                    <td style="padding-bottom:40px;">
                                        <a href="{{ route('groups.show',[encode_url($group['group_id'])]) }}" style=" border-radius:50px; text-align:center; background:#bbdc00; font-size:15px; font-weight:bold; color:#5a5a5a; max-width:240px; line-height:50px; display:block; margin:0 auto;"> {{ __('View Group') }}</a>
                                    </td>
                                </tr>
								<tr>
