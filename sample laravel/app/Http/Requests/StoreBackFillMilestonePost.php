...
class StoreBackFillMilestonePost extends FormRequest
{
    /**
    ...
    public function rules()
    {
        $rules = [
            ...
            'title'				=>'required|min:4|max:64|regex:/^[\pL\pM\pN\s]+$/u|unique:milestones,title,NULL,id,deleted_at,NULL',
	...
	public function messages()
    {
		$messages = [
			...
			'end_date.required'	 			=> 'Completion Date cannot be empty',
			'end_date.after_or_equal'	 	=> 'Completion date should not be less than the start date',
