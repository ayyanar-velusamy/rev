...
class StoreUserPost extends FormRequest
{
	...
	public function messages()
    {
        return [
			...
			'gradeId.required'		=> 'Please choose a grade',
	...
	// protected function getValidatorInstance() {
            ...
            // $validator->sometimes('gradeId.*', 'required', function($input) {
                // $gradeId = array_values($input->gradeId);
				// return count($gradeId) != count(array_filter($gradeId));
            // });
            // return $validator;
    // }
}
