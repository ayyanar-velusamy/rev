        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-8 col-sm-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
              <h2 class="text-uppercase mt-0">Meet Our Staff</h2>  
              <p class="rev-p"><b>Revival Homecare Agency</b> has a team of licensed, registered and competent medical practitioners. All our employees are friendly, compassionate and reliable in providing home care services. They went a series of background checks, screening and interview before they were hired.</p>
              
              <p class="rev-p">Our staff includes:</p>
                           
              <ul class="list-img">
              <li><img src="{{ asset('revival/images/list-icon.png') }}">Registered and licensed nurses</li>
              <li><img src="{{ asset('revival/images/list-icon.png') }}">Physical/Occupational/Speech Therapists</li>
              <li><img src="{{ asset('revival/images/list-icon.png') }}">Expert Physicians</li>
              <li><img src="{{ asset('revival/images/list-icon.png') }}">Home Health Aides</li>
              </ul>
              <br>
              <p class="rev-p">For your concerns and further inquiries, please contact us. Our staff will immediately get back to you.</p>
            </div> 
