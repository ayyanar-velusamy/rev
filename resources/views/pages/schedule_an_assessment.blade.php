        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-8 col-sm-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
              <h2 class="text-uppercase mt-0">Schedule an Assessment</h2>  
              <p class="rev-p"><b>Take the first step towards a healthier way of living. Please fill and submit our online form to schedule an assessment.</p>
              <iframe id="myframe" src="http://www.revivalhc.com/wp-content/themes/revivalhca/forms/appointmentForm.php" style="width:100%; border:0; overflow:hidden; height: 900px;"></iframe>
            </div> 
