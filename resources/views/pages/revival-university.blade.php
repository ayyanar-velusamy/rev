        ...
        <div class="rev_slider" data-version="5.0">
          <ul>
            ...
            <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="{{ asset('revival/images/bg/bg.jpg') }}" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
              <!-- MAIN IMAGE -->
              <img src="{{ asset('revival/images/bg/university.jpg') }}"  alt=""  data-bgposition="center 60%" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
              <!-- LAYERS -->
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-8 col-sm-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
              <h2 class="text-uppercase mt-0">Revival <span class="text-theme-color-2">University</span> </h2>  
              <h3>Our Events</h3>
              <p><a style="color:#0075ae" href="">Joint Replacement Flyer</a></p>
              ...
              <h3>Our Brochures</h3>
              <p><a style="color:#0075ae" href="">Management of Chronic Diseases and Wounds</a></p>
              <p><a style="color:#0075ae" href="">Quality Care In the Comfort of Your Own Home</a></p>
              <p><a style="color:#0075ae" href="">Osteoarthritis/ Hip Fracture</a></p>
              <p><a style="color:#0075ae" href="">COPD Chronic Obstructive Pulmonary Disease and Stroke</a></p>
              <p><a style="color:#0075ae" href="">Dementia / Fall Prevention Risk Factors & Improving the Quality of Life</a></p>
              <p>*disclaimer: please disregard our outdated contact information on these brochures and look under Contact Us for updated information</p>
            </div> 
