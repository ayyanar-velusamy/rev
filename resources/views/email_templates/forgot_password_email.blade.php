                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding-bottom:30px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">Your request for reset password has been received, click the link below to reset your password.</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom:25px;">
                                        <a href="{{ $link }}" style=" border-radius:50px; text-align:center; text-decoration:none; background:#bbdc00; font-size:15px; font-weight:bold; color:#5a5a5a; max-width:240px; line-height:50px; display:block; margin:0 auto;"> {{ __('Reset Password') }}</a>
                                    </td>
                                </tr>
								<tr>
                                    <td style="padding-bottom:40px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">If it is done with error, kindly ignore this message or If you did not request this, report this to {{ env('SUPPORT_EMAIL','') }}</span>
                                    </td>
                                </tr>
								<tr>
