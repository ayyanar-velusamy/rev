                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding-bottom:30px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">Your {{ env('APP_NAME','') }}  account has been inactivated.</span>
                                    </td>
                                </tr>
								<tr>
