                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding-bottom:30px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">Admin has updated your email address. Kindly check the updated email address for the verification link</span>
                                    </td>
                                </tr>
								<tr>
                                    <td style="padding-bottom:40px; ">
                                        <span style="text-align:center; max-width:520px; display:block; margin:0 auto; font-size: 14px;color:#323232;">Your updated email id is {{ $user->change_email }}</span>
                                    </td>
                                </tr>
								<tr>
