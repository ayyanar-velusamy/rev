...
class UserController extends BaseController
{
	...
	public function edit($id)
	{
        ...
        return view('user_management.edit', compact('user','roles','permissions'));
	}
	...
	public function profile_view(){
        ...
        return view('user_management.profile_view', compact('user','roles','permissions'));
	}
	...
	public function profile_edit(){
        ...
        return view('user_management.profile_edit', compact('user','roles','permissions'));
	}
